...
const genuineParts = [
    ...
    { code: 'LR144951', supplier: 'JRL0101', desc: 'WIRING - ENGINE COMPARTMENT', stock: 0, trade: 1452.88, band1: 1380.24, band2: 1307.59, band3: 1300.33, band4: 1293.06, min: 1264.01 },
    { code: 'T4A14492', supplier: 'JAG0101', desc: 'HARNESS', stock: 0, trade: 1594.13, band1: 1514.42, band2: 1434.72, band3: 1426.75, band4: 1418.78, min: 1386.89 },
    { code: 'T2H27531', supplier: 'JAM0101', desc: 'HARNESS', stock: 0, trade: 1920.87, band1: 1824.83, band2: 1728.78, band3: 1719.18, band4: 1709.57, min: 1671.16 },
    { code: 'S31124961', supplier: 'JAG0101', desc: 'Console - With Armrest', stock: 0, trade: 2038.08, band1: 1936.18, band2: 1834.27, band3: 1824.08, band4: 1813.89, min: 1773.17 },
    { code: 'A8J13980', supplier: 'JAG0101', desc: 'HARNESS -ENGINE', stock: 0, trade: 1723.12, band1: 1636.96, band2: 1550.81, band3: 1542.19, band4: 1533.58, min: 1499.11 },
    { code: 'B0356841', supplier: 'JAG0101', desc: 'PANEL - RAW', stock: 0, trade: 1934.49, band1: 1837.77, band2: 1741.04, band3: 1731.37, band4: 1721.7, min: 1683.01 },
    { code: 'C2D53227', supplier: 'JAM0101', desc: 'PANEL DOOR VENEER', stock: 0, trade: 1075.79, band1: 1022, band2: 968.21, band3: 962.83, band4: 957.45, min: 935.49 },
    { code: 'T4K11623', supplier: 'JAG0101', desc: 'CROSSMEMBER', stock: 0, trade: 1180.42, band1: 1121.4, band2: 1062.38, band3: 1056.48, band4: 1050.57, min: 1026.97 },
    { code: 'C2P10312YN', supplier: 'JAM0101', desc: 'PACK', stock: 0, trade: 4253.32, band1: 4040.65, band2: 3827.99, band3: 3806.72, band4: 3785.45, min: 3700.39 },
    { code: 'LR165827', supplier: 'JRL0101', desc: 'WIRING - ENGINE COMPARTMENT', stock: 0, trade: 1178.63, band1: 1119.7, band2: 1060.77, band3: 1054.87, band4: 1048.98, min: 1025.41 },
    { code: 'T2R19539', supplier: 'JAM0101', desc: 'HARNESS -BODY', stock: 0, trade: 3411.14, band1: 3240.58, band2: 3070.03, band3: 3052.97, band4: 3035.91, min: 2967.69 },
    { code: 'LR063494', supplier: 'JRL0101', desc: 'WIRING - MAIN', stock: 0, trade: 4262.63, band1: 4049.5, band2: 3836.37, band3: 3815.05, band4: 3793.74, min: 3708.49 },
    { code: 'LR136497', supplier: 'JRL0101', desc: 'COVER - REAR SEAT CUSHION', stock: 0, trade: 1195.76, band1: 1135.97, band2: 1076.18, band3: 1070.21, band4: 1064.23, min: 1040.31 },
    { code: 'LR060112', supplier: 'JRL0101', desc: 'Harness - Main', stock: 0, trade: 2197.11, band1: 2087.25, band2: 1977.4, band3: 1966.41, band4: 1955.43, min: 1911.49 },
    { code: 'C2D57737', supplier: 'JAM0101', desc: 'HARNESS -BODY', stock: 0, trade: 2844.15, band1: 2701.94, band2: 2559.74, band3: 2545.51, band4: 2531.29, min: 2474.14 },
    { code: 'C2C36245', supplier: 'JAM0101', desc: 'COVER-SQUAB', stock: 0, trade: 1517.09, band1: 1441.24, band2: 1365.38, band3: 1357.8, band4: 1350.21, min: 1319.87 }
];

const brandedParts = [
    { code: 'LR110026', supplier: 'JRL0101', desc: 'GASKET - ELRING - KIS', stock: 0, trade: 0.76, band1: 0.72, band2: 0.68, band3: 0.68, band4: 0.68, min: 0.66 },
    { code: '698199', supplier: 'VLO0101', desc: 'AIR FILTER - VALEO', stock: 0, trade: 4.88, band1: 4.64, band2: 4.39, band3: 4.37, band4: 4.34, min: 4.25 },
    { code: 'RTC3524', supplier: 'TDC0101', desc: 'CONNECTOR - LUCAS', stock: 0, trade: 2.42, band1: 2.3, band2: 2.18, band3: 2.17, band4: 2.15, min: 2.11 },
    { code: 'ERC8450H', supplier: 'HLA0101', desc: 'GLOW PLUG - HELLA', stock: 0, trade: 4.83, band1: 4.59, band2: 4.35, band3: 4.32, band4: 4.3, min: 4.2 },
    { code: 'C2D19766D', supplier: 'JAM0101', desc: 'KIT XE JO - DRIVE BELT - DAYCO', stock: 25, trade: 11.15, band1: 10.59, band2: 10.04, band3: 9.98, band4: 9.92, min: 9.7 },
    { code: 'PHD12817', supplier: 'PFX0101', desc: 'BLOWER ARM BUSH REAR - POWERFLEX', stock: 0, trade: 68.57, band1: 65.14, band2: 61.71, band3: 61.37, band4: 61.03, min: 59.66 },
    { code: 'S2044114', supplier: 'TDC0101', desc: 'FRT DISC ROTOR 10" 500ABARTH MCA', stock: 0, trade: 73.68, band1: 70, band2: 66.31, band3: 65.94, band4: 65.58, min: 64.1 },
    { code: 'S9J231', supplier: 'SCH0101', desc: 'GRINDER - CLUTCH SLAVE - SACHS', stock: 0, trade: 10.82, band1: 10.28, band2: 9.74, band3: 9.68, band4: 9.63, min: 9.41 },
    { code: 'XFB50032', supplier: 'HLA0101', desc: 'REAR LAMP RANGE ROVER (D4) VIN 6A ON - HELLA', stock: 0, trade: 150.1, band1: 142.59, band2: 135.09, band3: 134.34, band4: 133.59, min: 130.59 },
    { code: 'C6C2517', supplier: 'JAM0101', desc: 'ACTUATOR-SPRING-GENUINE', stock: 47, trade: 1.17, band1: 1.11, band2: 1.05, band3: 1.05, band4: 1.04, min: 1.02 },
    { code: 'SHB50017', supplier: 'DLP0101', desc: 'BRAKE HOSE ASSEMBLY - DELPHI', stock: 0, trade: 19.26, band1: 18.3, band2: 17.33, band3: 17.24, band4: 17.14, min: 16.76 },
    { code: 'C2P10564', supplier: 'JAM0101', desc: 'COATED BRAKE DISC GENUINE (HC VV - DELPHI', stock: 4, trade: 68.87, band1: 65.43, band2: 61.98, band3: 61.64, band4: 61.29, min: 59.92 },
    { code: 'S5400', supplier: 'WPC0101', desc: 'HEAD/AMP MOUNTING BOWL - WIPAC', stock: 0, trade: 18.18, band1: 17.27, band2: 16.36, band3: 16.27, band4: 16.18, min: 15.82 },
    { code: 'S90057', supplier: 'TDC0101', desc: 'COMPRESSOR - AIR CONDITIONING', stock: 0, trade: 230.84, band1: 219.3, band2: 207.76, band3: 206.6, band4: 205.45, min: 200.83 },
    { code: 'JTC384', supplier: 'TRW0101', desc: 'ARM - CONTROL - TRW', stock: 0, trade: 36.08, band1: 34.28, band2: 32.47, band3: 32.29, band4: 32.11, min: 31.39 },
    { code: 'T2R13126', supplier: 'JAM0101', desc: 'SPRING-ROW - EM SUSPENSION', stock: 40, trade: 9.4, band1: 8.93, band2: 8.46, band3: 8.41, band4: 8.37, min: 8.18 },
    { code: 'ETC8751E', supplier: 'EBC0101', desc: 'TURBOCHARGER REMAN - REMAN - ES', stock: 0, trade: 366.73, band1: 348.39, band2: 330.06, band3: 328.22, band4: 326.39, min: 319.06 },
    { code: 'SHB00830', supplier: 'BRM0101', desc: 'BRAKE HOSE - BREMI', stock: 0, trade: 20.47, band1: 19.45, band2: 18.42, band3: 18.32, band4: 18.22, min: 17.81 },
    { code: 'LRD19663', supplier: 'JRL0101', desc: 'RETAINER CYL HEAD COVER 2.4 DURATORQ - ELRING', stock: 0, trade: 2.7, band1: 2.56, band2: 2.43, band3: 2.42, band4: 2.4, min: 2.35 },
    { code: 'LRD56138', supplier: 'JRL0101', desc: 'PCKG FILTER - MANN', stock: 444, trade: 19.48, band1: 18.51, band2: 17.53, band3: 17.43, band4: 17.34, min: 16.95 },
    { code: 'C2S39552', supplier: 'JAM0101', desc: 'LINK ANTI ROLL BAR - DELPHI', stock: 1, trade: 11.64, band1: 11.06, band2: 10.48, band3: 10.42, band4: 10.36, min: 10.13 },
    { code: 'LR126074', supplier: 'JRL0101', desc: 'LAND ROVER DISCOVERY SPORT 15- RR CHN BUILT WINI', stock: 20, trade: 47.26, band1: 44.9, band2: 42.53, band3: 42.3, band4: 42.06, min: 41.12 },
    { code: 'LRD29941', supplier: 'JRL0101', desc: 'BEARING - LNOS/LNOS', stock: 0, trade: 0.91, band1: 0.86, band2: 0.82, band3: 0.81, band4: 0.81, min: 0.79 },
    { code: 'S5190212', supplier: 'TDC0101', desc: 'T/B COVER LEFT /13/5T5', stock: 0, trade: 33.28, band1: 31.62, band2: 29.95, band3: 29.79, band4: 29.62, min: 28.95 },
    { code: 'C2674D', supplier: 'JAM0101', desc: 'TRAILER LIMOUSINE - IDLER SPROCKET - EAC PARTS', stock: 2, trade: 38.32, band1: 36.4, band2: 34.49, band3: 34.3, band4: 34.1, min: 33.34 },
    { code: 'LHN10042', supplier: 'JRL0101', desc: 'BELT - DAYCO', stock: 11, trade: 7.19, band1: 6.83, band2: 6.47, band3: 6.44, band4: 6.4, min: 6.26 }
];
