...
const adminAnnouncements: Announcement[] = [
  {
    ...
    message: 'Scheduled maintenance will occur on Sunday, Jan 20th from 2:00 AM to 4:00 AM GMT. System will be unavailable during this time.',
  ...
  },
  {
    ...
    message: '3 new dealer applications pending review. Please review and approve/reject within 48 hours.',
  ...
  },
  {
    ...
    message: 'Q1 2026 performance report is now available in the Reports section. Review dealer performance metrics and sales data.',
          ...
          >
            <div className="p-6">
              ...
              <nav className="space-y-2">
                <a href="/admin/dashboard" className="block py-2 text-slate-700 hover:text-blue-600">
                  Dashboard
                </a>
                ...
                <a href="/admin/templates" className="block py-2 text-slate-700 hover:text-blue-600">
                  Templates
                </a>
                <a href="/admin/imports" className="block py-2 text-slate-700 hover:text-blue-600">
                  Imports
                </a>
                <a href="/admin/order-entry" className="block py-2 text-slate-700 hover:text-blue-600">
                  Order Entry
                </a>
              </nav>
            </div>
