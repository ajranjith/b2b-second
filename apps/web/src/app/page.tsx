    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <section className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_1fr] items-center">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-blue-600">B2B Parts Platform</p>
            ...
            <p className="mt-4 text-lg text-slate-600">
              Distributing quality spare parts throughout the world since 1972. Search, order, and track in minutes.
            </p>
          ...
          <div
            ...
            style={{ backgroundImage: "url('/hero-b2b.svg')", backgroundSize: 'cover', backgroundPosition: 'center' }}
          >
        ...
        <section className="mt-14 grid gap-6 md:grid-cols-3">
          {[
            { title: 'Live Availability', body: 'See stock levels and lead times across core lines.' },
            { title: 'Account Pricing', body: 'Band pricing and entitlements applied automatically.' },
