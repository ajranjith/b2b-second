...
export const mockAnnouncements: Announcement[] = [
  {
    ...
    fullText:
      "Exclusive dealer offer: 10% discount on all genuine Land Rover parts throughout January. Use code GENUINE10 at checkout. Valid on orders over £500.",
    priority: 0,
  ...
  },
  {
    ...
    fullText:
      "We will be performing scheduled system maintenance this weekend from Saturday 2:00 AM to 6:00 AM GMT. During this time, the portal may be temporarily unavailable. We apologize for any inconvenience.",
    priority: 1,
  ...
  },
  {
    ...
    fullText:
      "We are experiencing high demand for brake pad kits (LR123456). Current stock levels are running low. Please place your orders as soon as possible to avoid potential delays. Expected restock: January 25th.",
    priority: 2,
