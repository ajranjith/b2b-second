...
const adminAnnouncements: Announcement[] = [
  {
    ...
    shortText: "Scheduled maintenance on Sunday, Jan 20th from 2:00 AM to 4:00 AM GMT.",
    fullText:
  ...
  },
  {
    ...
    shortText: "3 dealer applications pending review. Please review within 48 hours.",
    fullText:
  ...
  },
  {
    ...
    shortText: "Q1 2026 report is available in Reports. Review dealer performance metrics.",
    fullText:
  ...
  },
  {
    ...
    shortText: "Order volume is 45% above normal. Consider additional support resources.",
    fullText:
      "Order volume is 45% above normal. Consider allocating additional support resources.",
