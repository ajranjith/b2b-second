            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-900">
                  <strong>Note:</strong> Ensure all required fields are filled and data formats
                  match the examples shown above. Invalid rows will be flagged during the import
                  process.
                </p>
              </div>
            </div>
