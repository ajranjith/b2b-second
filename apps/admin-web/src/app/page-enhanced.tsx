          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-slate-900 leading-tight">
                Genuine and aftermarket <span className="text-blue-600">parts</span>, priced for
                your account
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed">
                Distributing quality spare parts worldwide since 1972. Search, order, and track in
                minutes with our advanced B2B platform.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Explore our comprehensive range of genuine and aftermarket parts for Jaguar, Land
              Rover, and Rover vehicles.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-2">
              ...
              <p className="text-sm leading-relaxed">
                Original Jaguar, Land Rover and Rover vehicle parts specialist. Distributing quality
                spare parts worldwide since 1972.
              </p>
            </div>
            <div>
