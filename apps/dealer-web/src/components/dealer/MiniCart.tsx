                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-600 truncate">{item.product.description}</p>
                      <Badge variant="outline" className="mt-1 text-xs bg-slate-100 text-slate-700">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center border border-slate-200 rounded">
                        ...
                        <span className="text-sm font-medium w-10 md:w-8 text-center">
                          {item.qty}
                        </span>
                        <Button
                          variant="ghost"
                      ...
                      <span className="text-sm font-bold text-blue-600 min-w-[60px] text-right">
                        GBP{" "}
                        {Number(item.lineTotal ?? Number(item.yourPrice ?? 0) * item.qty).toFixed(
                          2,
                        )}
                      </span>
                    </div>
