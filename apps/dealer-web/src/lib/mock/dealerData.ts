...
export const announcements: Announcement[] = [
  {
    ...
    body: "Standard dispatch runs at 16:30. Express cut-off is now 14:00. Collection bookings must be placed by 12:00.",
    date: "2026-01-12",
    attachments: [
  ...
  },
  {
    ...
    body: "Priority fulfillment for core Jaguar platforms is active this week. Contact support to flag critical VIN orders.",
    date: "2026-01-15",
  ...
  },
  {
    ...
    body: "Band 1 parts move to a 3.5% adjustment. Review your most purchased SKUs to confirm margin targets.",
    date: "2026-01-18",
